...
namespace DMC.DAL
{
    public class DeviceCategoryDAL
    {
        ...
        /// <returns></returns>
        public bool NewDeviceCategory(DeviceCategoryEntity entity)
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append("Insert into t_DeviceCategory(CategoryId,CategoryName,OrderId,PCategoryId,Usey,CategoryText)");
        ...
        /// <returns></returns>
        public bool IsExists(DeviceCategoryEntity entity)
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append("SELECT COUNT(1) FROM t_DeviceCategory WHERE CategoryId=@CategoryId or CategoryName=@CategoryName ");
            List<DbParameter> param = new List<DbParameter>();
            param.Add(DBFactory.Helper.FormatParameter("CategoryId", DbType.String, entity.CategoryId));
            param.Add(DBFactory.Helper.FormatParameter("CategoryName", DbType.String, entity.CategoryName));
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public bool UpdateDeviceCategory(DeviceCategoryEntity entity)
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append("Update t_DeviceCategory");
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable GetAllDeviceCategory()
        {
            return DBFactory.Helper.ExecuteDataSet("SELECT * FROM t_DeviceCategory WHERE Usey='Y'", null).Tables[0];
        }
    }
}
