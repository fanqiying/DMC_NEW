...
var TipsDiv = $('<div id="TipsDiv" style="overflow:auto;height: '+divhei+'px;width:160px;position: absolute;z-index:999999;border:1px solid #E8E8E8;background: #fff;">'+
		            ...
		            if (data.length > 0) {
		                ...
		                $.each(data, function (i, n) {
		                    $('#Tips-result').append('<li style="padding:5px;" id="Tips-result-' + i + '" onclick="doLi(this)">'
									+ n.userMail + '(' + n.userName + '/' + n.userID + ')' + '</li>');
		                });
