...
var TipsDiv = $('<div id="TipsDiv" style="overflow:auto;height: ' + divhei + 'px;width:300px;position: absolute;z-index:999999;border:1px solid #E8E8E8;background: #ebf5f5;">' +
		'<span id="Tips-result"></span>' +
		'</div>');

var inputEl;

var doLior = function (liop) {
...
function autoTips(opts) {
                ...
                success: function (data) {
                    if (data.length > 0) {
                        ...
                        $.each(data, function (i, n) {
                            $('#Tips-result').append('<li style="padding:5px;" id="Tips-result-' + i + '" onclick="doLior(this)">' + n.CusCode + '-' + n.CusName + '' + '</li>');
                        });
                        ...
                        $('span li').mouseover(function () {
                            ...
                            $(this).css("backgroundColor", "#e0e3e3");
    ...
    var selectLi = function (ops) {
        ...
        $(ops).css("backgroundColor", "#e0e3e3");
    };
