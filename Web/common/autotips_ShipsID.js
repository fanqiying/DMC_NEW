...
var TipsDiv = $('<div id="TipsDiv" style="overflow:auto;height: ' + divhei + 'px;width:150px;position: absolute;z-index:999999;border:1px solid #E8E8E8;background: #fff;">' +
...
function autoTipShips(opts, sysNumber) {
    inputSocure = opts;
    ...
    if (keywords.length <= 1) {
        ...
        if (keywords != "") {
            $.ajax({
                type: 'POST',
                url: '../../../ASHX/FerryChart.ashx?M=getshipmentsformlikeid&SingleNumber=' + sysNumber + '&id=' + keywords + '',
                dataType: 'json',
                data: { menuID: keywords },
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function (i, n) {
                            $('#Tips-result').append('<li style="padding:5px;" id="Tips-result-' + i + '" onclick="doLi(this)">'
									+ n.SingleNumber + '</li>');
                        });
