...
function autoTipsCus(opts) {
    var op = opts || { keyword: "" };
    var keyword = op.keyword;
    if (keywordsold == keyword) return;
    keywordsold = keyword;
                ...
                success: function (data) {
                    if (data.length > 0) {
                        ...
                        $.each(data, function (i, n) {
                            $('#Tips-result').append('<li style="padding:5px;" id="Tips-result-' + i + '" onclick="doLiLili(this)">' + n.CusCode + '-' + n.CusName + '' + '</li>');
                        });
