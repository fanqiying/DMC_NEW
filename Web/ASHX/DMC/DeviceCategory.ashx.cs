...
{
    /// <summary>
    /// DeviceCategory 的摘要描述
    /// </summary>
    public class DeviceCategory : IHttpHandler, IRequiresSessionState
    {
        //變量定義以及相關類的實例化
        ...
        DeviceCategoryService dcs = new DeviceCategoryService();
            ...
            if (currentUser != null)
            {
                ...
                switch (method)
                {
                    case "search":
                        Search(context);
                        break;
                    case "newdevicecategory":
                        NewDeviceCategory(context);
                        break;
                    case "updatedevicecategory":
                        UpdateDeviceCategory(context);
                        break;
                    case "getdevicetree":
                        GetDeviceTree(context);
                        break;
                }
            }
            else
        ...
        public void Search(HttpContext context)
        {
            ...
            //取得相關查詢條件下的數據列表
            DataTable dt = dcs.Search(pagesize, pageindex, out pageCount, out total, strWhere.ToString());
        ...
        /// </summary>
        /// <param name="context"></param>
        public void NewDeviceCategory(HttpContext context)
        {
            try
            {
                ...
                string msg = dcs.NewDeviceCategory(entity);
        ...
        /// </summary>
        /// <param name="context"></param>
        public void UpdateDeviceCategory(HttpContext context)
        {
            try
            {
                DeviceCategoryEntity entity = new DeviceCategoryEntity();
                ...
                entity.Usey = context.Request["Usey"];
                entity.CategoryText = string.IsNullOrEmpty(entity.PCategoryId) ? entity.CategoryName : entity.PCategoryText + "->" + entity.CategoryName;
                string msg = dcs.UpdateDeviceCategory(entity);
                if (string.IsNullOrWhiteSpace(msg))
                {
        ...
        /// </summary>
        /// <param name="context"></param>
        public void GetDeviceTree(HttpContext context)
        {
            StringHelper.JsonGZipResponse(context, dcs.GetDeviceTree());
        }
