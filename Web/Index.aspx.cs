...
namespace Web
{
    public partial class Index : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //RepairmanList.Columns.Add("autoid", typeof(string));
            //for (int i = 0; i < 8; i++)
            //{
            //    DataRow dr = RepairmanList.NewRow();
            //    dr["autoid"] = i;
            //    RepairmanList.Rows.Add(dr);
            //}
            base.OnInit(e);
        }
        ...
        {
            string src = "DefaultHome.aspx";
            if (defaultRole == "操作员")
            {
                src = "UI/Equment/RepairForm.aspx";
            }
            return src;
        }
