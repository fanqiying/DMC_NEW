<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderAppraise.aspx.cs" Inherits="Web.UI.Equment.LeaderAppraise" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#tbAppraise').datagrid({
                ...
                checkOnSelect: false,
                selectOnCheck: false,
                url: '../../ASHX/DMC/RepairRecord.ashx?M=Search&SearchType=ByAdvanced&repairstatus=3',
                //數據在一行顯示 
                nowrap: false,
                fitColumns: true,
                //行條紋化
